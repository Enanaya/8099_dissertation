...
contract SMT is StandardToken {
    ...
    function transferProxy(address _from, address _to, uint256 _value, uint256 _feeSmt
        ...
        uint256 temp=_value+_feeSmt;
        if(balances[_to] .add( _value) < balances[_to]
            || balances[msg.sender] .add( _feeSmt) < balances[msg.sender]) revert();
        balances[_to] += _value;
         Transfer(_from, _to, _value);
     ...
     * @param _s
     */
    function approveProxy(address _from, address _spender, uint256 _value) public returns (bool success) {
